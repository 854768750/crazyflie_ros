...
class Multi_circle_2():
    def __init__(self, goals):
        rospy.init_node('multi_circle_2', anonymous=True)
	...
	#rospy.loginfo("start running!")
	    ...
	    #rospy.loginfo("start running!")
            ...
            t1 = self.listener.getLatestCommonTime(self.worldFrame, self.frame)
            if self.listener.canTransform(self.worldFrame, self.frame, t1):
                position, quaternion = self.listener.lookupTransform(self.worldFrame, self.frame, t1)
