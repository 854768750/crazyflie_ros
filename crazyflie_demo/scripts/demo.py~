    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.listener.canTransform(self.worldFrame, self.frame, t):
                ...
                if     math.fabs(position[0] - self.goals[self.goalIndex][0]) < 0.25 \
                   and math.fabs(position[1] - self.goals[self.goalIndex][1]) < 0.25 \
                   and math.fabs(position[2] - self.goals[self.goalIndex][2]) < 0.25 \
